class IssuesExtension extends Autodesk.Viewing.Extension {
        ...
        async _createMarkups(partIds) {
                console.log("IssuesExtension : _createMarkups : partIds : " + partIds);
                ...
                for (const issue of this._issues) {
                    //partId, text, author, x, y, z
                    console.log("issue id : " + issue._id);
                    console.log("issue partId : " + issue.partId);
                    console.log("issue text : " + issue.text);
                    console.log("issue author : " + issue.author);
                    console.log("issue x : " + issue.x);
                    console.log("issue y : " + issue.y);
                    console.log("issue z : " + issue.z);
    ...
    _updateMarkups() {
        console.log("IssuesExtension : _updateMarkups");
        const viewer = this.viewer;
    ...
    _getIssuePosition(issue) {
        console.log("IssuesExtension : _getIssuePosition : issue : " + issue);
    ...
    _removeMarkups() {
        console.log("IssuesExtension : _removeMarkups");
